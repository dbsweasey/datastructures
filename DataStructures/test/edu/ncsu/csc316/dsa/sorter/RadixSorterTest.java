...
public class RadixSorterTest {
	...
	/** Stores the RadixSorter used to sort data */
	private RadixSorter<Student> sorter;

	/**
	 * Creates the students and sorter to be used in testing
	 */
	@Before
	public void setUp() {
	...
	/**
	 * Tests RadixSorter on a list of students in random order
	 */
	@Test
	...
	/**
	 * Tests RadixSorter on a list of students in ascending order
	 */
	@Test
	...
	/**
	 * Tests RadixSorter on a list of students in descending order
	 */
	@Test
