...
public class SkipListMapTest {
    ...
    public void testPut() {
        ...
        assertEquals("SkipListMap[3, 4, 6]", map.toString());
        assertEquals(3, map.size());
        
        assertNull(map.put(2, "string2"));
        assertEquals("SkipListMap[2, 3, 4, 6]", map.toString());
        assertEquals(4, map.size());
        
        assertNull(map.put(5, "string6"));
        assertEquals("SkipListMap[2, 3, 4, 5, 6]", map.toString());
    ...
    public void testStudentMap() {
        ...
        assertEquals("SkipListMap[Student [first=J, last=S, id=2, creditHours=0, gpa=0.0, unityID=js]]", studentMap.toString());
        ...
        assertEquals("SkipListMap[Student [first=J, last=J, id=4, creditHours=0, gpa=0.0, unityID=jj], "
