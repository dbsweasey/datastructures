...
public abstract class AbstractPriorityQueue<K extends Comparable<K>, V> implements PriorityQueue<K, V> {
	...
	/** The comparator to use when determining priority of keys */
    ...
    public static class PQEntry<K, V> implements Entry<K, V> {
    	/** The key stored within the priority-queue entry */
        private K key;
        
        /** The value stored within the priority-queue entry */
        private V value;
     ...
     * @return a new priority-queue entry
     */
