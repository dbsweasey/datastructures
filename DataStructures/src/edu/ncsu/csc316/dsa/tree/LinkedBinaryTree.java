...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
    ...
    public Position<E> addRight(Position<E> p, E value) {
        BinaryTreeNode<E> node = validate(p);
        if (right(node) != null && right(node).getElement() != null) {
...
//        }
    ...
    /**
     * Creates a new node in the LinkedBinaryTree. Has references to a parent, the left child, and the right child which are all 
